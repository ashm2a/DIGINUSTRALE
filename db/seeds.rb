...
porc_two = { user: user, boucle: 00007, boucle_mère: 00003, boucle_père: 00004, date_de_naissance: Date.new(2019, 12, 10), sexe: "mâle", abattage: porc_abattage }
porc_three = { user: user, boucle: 00006, boucle_mère: 00005, boucle_père: 00007, date_de_naissance: Date.new(2019, 12, 10), sexe: "femelle", abattage: porc_abattage }
