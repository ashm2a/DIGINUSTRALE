...
puts "Creating porcs..."
porc_one = { user: user, boucle: "00011", boucle_mère: "00001", boucle_père: "00002", date_de_naissance: Date.new(2019, 11, 10), sexe: "femelle", abattage: porc_abattage }
...
porc_four = { user: user, boucle: "00010", boucle_mère: "00001", boucle_père: "00002", date_de_naissance: Date.new(2019, 11, 10), sexe: "mâle", abattage: porc_abattage }
